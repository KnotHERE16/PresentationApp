<!-- Same as register page with an error to show studentid is not 8 numbers -->
...
<div class="register">
	...
	<p style="color:red"> Your student ID must be 8 numbers! Please put in corrent student ID. </p>
