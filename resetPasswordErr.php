<!-- Same as resetPassword page with an error to show something is wrong -->
...
<form action="process/resetPassword2.php" method="POST">
	...
	<p style="color:red"> Something is wrong. Please try again! </p>
  <input type="submit" class="submit" id="submit" value="Submit" onclick="checkpassword()" disabled> 
