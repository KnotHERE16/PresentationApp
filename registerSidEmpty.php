<!-- Same as register page with an error to show student ID is empty -->
...
<div class="register">
	...
	<p style="color:red"> Your Student ID is empty! Please try again and enter your student ID. </p>
