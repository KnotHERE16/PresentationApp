...
<body><h2 style="text-align:center; font-size:30pt">Assessment </h2>
...
<input type="number" name="sid" id="sid" class="right" size="10" pattern=".{8}"required>  
...
<input class="remark" name="remark" type="text" size="30" > 
</fieldset>
<br>

Total <input id="total" type="text" name="total" value="" size="5"/>/30
